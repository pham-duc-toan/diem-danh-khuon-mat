    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FaceDataSet", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FaceDataSet_Users_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceSessions_ClassSessions_ClassSessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FaceConfidence = table.Column<double>(type: "double precision", nullable: false),
                    ImagePath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FullName", "PasswordHash", "Role", "StudentCode", "Username" },
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "System Administrator", "$2a$11$KzeeAqEJOUESk2yg34M2sO0OjmZP0VjRzOysEZh/yymQK9O3BFKpa", "Admin", null, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSessions_ClassSessionId",
